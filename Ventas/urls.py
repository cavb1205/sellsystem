...
urlpatterns = [
    ...
    path('<int:pk>/correccion-administrativa/', views.corregir_venta_administrativamente, name='corregir_venta_administrativamente'),
    path('<int:pk>/correccion-administrativa/t/<str:tienda_id>/', views.corregir_venta_administrativamente, name='corregir_venta_administrativamente_admin'),
